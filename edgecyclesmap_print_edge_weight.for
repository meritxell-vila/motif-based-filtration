...
*corrected pentagons
      ...
      character*90 fileout_tr,fileout_sq,fileout_pt
...
*      fileoutk='test_degrees.dat'
      ...
      CALL get_command_argument(3, fileoutk)
      CALL get_command_argument(4, fileout_tr)
      CALL get_command_argument(5, fileout_sq)
      CALL get_command_argument(6, fileout_pt)
...
10    continue
      close(1)
            ...
            open(123,file=fileout_tr,status='replace')
            open(124,file=fileout_sq,status='replace')
            open(125,file=fileout_pt,status='replace')
*********clustering
...
*                 write(6,*)'normalization pentagons ',mpent,nnor
              ...
              write(123,*) nodo1, nodo2, mledge, xtrans
              write(124,*) nodo1, nodo2, msq, xledge
              write(125,*) nodo1, nodo2, mpent, xpent
            ...
            ! write(1,*)"Average degree of nodes",xk
            ! write(1,*)"Average clustering of nodes",xckiter
            ! write(1,*)"Links with nodes k>1",nl1
            ! write(1,*)"Average clustering of links",xceiter
            ! write(1,*)"Error average clustering of links",xerrorace
            ! write(1,*)"Triangles",ntt
            ! write(1,*)"Average squares of links",xsqiter
            ! write(1,*)"Error average squares of links",xerrorasq
            ! write(1,*)"Squares",nts
            ! write(1,*)"Average pentagones of links",xpiter
            ! write(1,*)"Error average pentagones of links",xerrorap
            ! write(1,*)"Pentagons",ntp
            write(1,*)xceiter,",",xsqiter,",",xpiter
     +           ,",",ntt,",",nts,",",ntp
            close(1)
